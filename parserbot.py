...
bot = telebot.TeleBot('1430474830:AAHUMXvUvFSFiC0hF6DiHBEL2BngCgjiuLs')
...
def get_users_id_and_username(message):
    ...
    if message.chat.type == 'private':
        ...
        bot.send_message(chat_id, f'Привет {name}! Я Кай, буду проводить для тебя StandUp каждое утро')
...
@bot.message_handler(commands=['Kai', 'change'])
